...
Dernière correction du menu : suppression des règles masquant le bouton de rendez-vous entre 1100 et 1499 px. Navigation adaptée entre 1100 et 1250 px pour conserver le bouton sans chevauchement ; menu mobile et bouton centré préservés. Note du préparateur : « Vous envoyez le message via WhatsApp. » et équivalent anglais. Contrôle du menu FR/EN sur 12 largeurs de 320 à 1920 px, avec vérification de navigation mobile et absence de débordement des autres pages à 390/1100/1440 px.

Aperçus de partage du 25 septembre : accueil FR « Massages et bien-être », EN « Massage and wellbeing », dans le titre, la description, les cartes et leurs textes alternatifs. Nouvelles images versionnées par Astro ; les messages WhatsApp déjà envoyés peuvent conserver leur ancienne vignette.
